...
CROPS = [
    ...
    ("lettuce", "Lettuce", "\U0001F96C", "Cool-season leafy",
     "Cool · 14-21 °C · VPD 0.4-1.0 kPa", [
        dict(dT=(16,20), nT=(10,14), dH=(65,75), dV=(0.40,0.70), L=(14,10)),
        dict(dT=(16,21), nT=(10,15), dH=(60,70), dV=(0.65,0.90), L=(14,10)),
        dict(dT=(15,20), nT=(8,13),  dH=(55,70), dV=(0.70,0.95), L=(12,12)),
        dict(dT=(14,19), nT=(8,12),  dH=(55,65), dV=(0.70,1.00), L=(12,12)),
        dict(dT=(14,19), nT=(8,12),  dH=(55,65), dV=(0.70,1.00), L=(10,14)),
     ]),
    ("spinach", "Spinach", "\U0001F33F", "Cool, bolts in long days",
     "Cool · 12-20 °C · short days · VPD 0.4-1.0 kPa", [
        dict(dT=(15,20), nT=(8,12), dH=(60,70), dV=(0.40,0.70), L=(12,12)),
        dict(dT=(15,20), nT=(8,13), dH=(55,70), dV=(0.60,0.90), L=(12,12)),
        dict(dT=(13,18), nT=(7,12), dH=(55,65), dV=(0.70,0.95), L=(10,14)),
        dict(dT=(12,18), nT=(6,11), dH=(50,65), dV=(0.70,1.00), L=(10,14)),
        dict(dT=(12,18), nT=(6,11), dH=(50,65), dV=(0.70,1.00), L=(10,14)),
     ]),
    ("kale", "Kale", "\U0001F96C", "Cold-hardy leafy",
     "Cool-hardy · 12-21 °C · VPD 0.45-1.05 kPa", [
        dict(dT=(16,21), nT=(10,14), dH=(60,70), dV=(0.45,0.75), L=(14,10)),
        dict(dT=(15,21), nT=(8,14),  dH=(55,70), dV=(0.70,0.95), L=(14,10)),
        dict(dT=(13,20), nT=(6,12),  dH=(55,65), dV=(0.70,1.00), L=(12,12)),
        dict(dT=(12,19), nT=(4,11),  dH=(50,65), dV=(0.75,1.05), L=(12,12)),
        dict(dT=(12,19), nT=(4,11),  dH=(50,65), dV=(0.75,1.05), L=(12,12)),
     ]),
    ("basil", "Basil", "\U0001F33F", "Warm culinary herb",
     "Warm herb · 22-28 °C · VPD 0.45-1.4 kPa", [
        dict(dT=(22,26), nT=(18,21), dH=(65,75), dV=(0.45,0.80), L=(16,8)),
        dict(dT=(22,28), nT=(18,21), dH=(60,70), dV=(0.70,1.00), L=(16,8)),
        dict(dT=(22,28), nT=(18,20), dH=(55,65), dV=(0.80,1.10), L=(14,10)),
        dict(dT=(22,27), nT=(17,20), dH=(50,65), dV=(0.85,1.15), L=(14,10)),
        dict(dT=(20,24), nT=(18,22), dH=(40,55), dV=(1.00,1.40), L=(12,12)),  # leaf drying
     ]),
